...
export async function init() {
    ...
    openBtn.addEventListener('click', function (event) {
        ...
        // Remove existing origin-elements to avoid conflicts
        ...
        if (editBtn) {
            ...
            if (product) {
                ...
                if (window.toggleDialog) {
                    ...
                    const dialog = document.getElementById('edit-product-modal');
                    if (dialog) {
                        dialog.showModal();
                        document.body.style.overflow = "hidden";
                    }
        ...
        if (deleteBtn) {
            ...
            if (product) {
                ...
                if (window.toggleDialog) {
                    ...
                    const dialog = document.getElementById('delete-product-modal');
                    if (dialog) {
                        dialog.showModal();
                        document.body.style.overflow = "hidden";
                    }
